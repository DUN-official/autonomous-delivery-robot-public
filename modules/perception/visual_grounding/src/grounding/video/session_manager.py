    ...
    def _run(
        ...
        *,
        ...
        try:
            ...
            # ``processor.process`` returns a summary that already contains
            # ``session_id``.  Passing that dictionary directly alongside the
            # positional session_id argument gives _update() the same argument
            # twice and raises:
            #   TypeError: _update() got multiple values for argument 'session_id'
