...
_BACKENDS = {"yolo", "grounding_dino", "owlvit", "gpt_vision", "gpt_guided_owlvit"}
...
class LLMVideoTaskParser:
    ...
    def _prompt(instruction: str) -> str:
        schema = {
            ...
            "recommended_backend": "yolo | grounding_dino | owlvit | gpt_vision | gpt_guided_owlvit",
            "confidence": 0.0,
        }
        return (
...
def _from_service_payload(
    ...
    if backend not in {"yolo", "grounding_dino", "owlvit", "gpt_vision", "gpt_guided_owlvit"}:
